...
--select * from [dbo].Udf_GetInterestStruc_Emi(228,20250211)
          ...
          RETURNS	@Result TABLE(DueNo TINYINT, DueDate DATE, DueAmt MONEY, PaidDate DATE, PaidAmt INT, Delay_Days SMALLINT, OtherCredits MONEY)
        ...
        WITH ENCRYPTION AS
          ...
          DECLARE @AsOn DATE = [dbo].IntToDate(@AsOnDate)
